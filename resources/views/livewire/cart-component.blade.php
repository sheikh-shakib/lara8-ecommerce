        ...
        <div class=" main-content-area">
                ...
                <ul class="products-cart">
                    <li class="pr-cart-item">
                        <div class="product-image">
                            <figure><img src="{{asset('assets')}}/web/assets/images/products/{{$item->model->image}}" alt=""></figure>
                        </div>
                        ...
                        <div class="quantity">
                            <div class="quantity-input">
                                ...
                                <a class="btn btn-increase" href="#" wire:click="increaseQty('{{$item->rowId}}')"></a>
                                <a class="btn btn-reduce" href="#" wire:click="decreaseQty('{{$item->rowId}}')"></a>
                            </div>
                        </div>
            ...
            <div class="summary">
                ...
                <div class="update-clear">
                    <a class="btn btn-clear" wire:click="destroyAll()" href="#">Clear Shopping Cart</a>

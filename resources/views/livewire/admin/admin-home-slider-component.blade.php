                ...
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <div class="row">
                            ...
                            <div class="col-md-6"><a class="btn btn-success pull-right" href="{{route('admin.addhomeSlider')}}">Add Slider</a></div>
                        </div>
                    </div>
                        ...
                        <table class="table table-striped">
                            ...
                            <tbody>
                                @foreach ($sliders as $slider)
                                    <tr>
                                        <td>{{$slider->id}}</td>
                                        <td><img src="{{asset('assets')}}/web/assets/images/sliders/{{$slider->image}}" width="120" alt=""></td>
                                        <td>{{$slider->title}}</td>
